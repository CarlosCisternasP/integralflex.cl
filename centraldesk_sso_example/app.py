...
def home():
    ...
    return "<h1>CentralDesk</h1><p>Usa /sso/login?token=...</p>"
...
@login_required
def dashboard():
    return f"<h1>CentralDesk Dashboard</h1><p>Bienvenido {current_user.username or current_user.email} | RUT: {current_user.rut}</p><p><a href='/logout'>Logout</a></p>"
